...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final EditText input_fecha = (EditText) mView1.findViewById(R.id.Fecha);
                ...
                btnSave.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (lastname.equals("") && firstname.equals("") && middlename.equals("") && contact.equals("") && fecha.equals("")){
                            Snackbar.make(view,"Field incomplete",Snackbar.LENGTH_SHORT).show();

                        }else {
                            Save(lastname,firstname,middlename,contact,fecha);
                            dialog.dismiss();
    ...
    private void Save(String lastname, String firstname, String middlename, String contact, String fecha) {
